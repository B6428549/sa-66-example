...
async function GetHoteltypes() {
  ...
  let res = await fetch(`${apiUrl}/hoteltypes`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function DeleteHotelByID(id: Number | undefined) {
  const requestOptions = {
    method: "DELETE"
  };
...
async function GetHotelById(id: Number | undefined) {
  const requestOptions = {
    method: "GET"
  };

  let res = await fetch(`${apiUrl}/hotel/${id}`, requestOptions)
    .then((response) => response.json())
    .then((res) => {
      if (res.data) {
        return res.data;
...
async function UpdateHotel(data: HotelsInterface) {
  const requestOptions = {
    method: "PATCH",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data),
